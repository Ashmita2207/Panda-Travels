...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="Pandas Pub and Restaurant" /></a></h1>
        <ul id="mainnav">
	...
	<div id="footer">
	<h4>(+91)-7544-267051 &bull; <a href="contact-us.php">Jaypee University of Engineering and Technology, Guna</a></h4>
	...
	<p>&copy; Copyright 2021 Panada Travels | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
